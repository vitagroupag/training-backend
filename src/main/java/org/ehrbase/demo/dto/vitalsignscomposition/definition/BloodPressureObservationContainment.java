...
public class BloodPressureObservationContainment extends Containment {
  ...
  public ListSelectAqlField<BloodPressureAnyEventPointEvent> ANY_EVENT = new ListAqlFieldImp<BloodPressureAnyEventPointEvent>(BloodPressureObservation.class, "/data[at0001]/events[at0006]", "anyEvent", BloodPressureAnyEventPointEvent.class, this);
