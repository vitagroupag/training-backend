...
@Generated(
    ...
    date = "2023-05-10T09:56:55.565811085Z",
...
public class BodyTemperatureAnyEventIntervalEvent implements IntervalEventEntity, BodyTemperatureAnyEventChoice {
  ...
  /**
   * Path: vital_signs/Body temperature/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: vital_signs/Body temperature/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: vital_signs/Body temperature/Any event/sample_count
   */
  @Path("/sample_count")
